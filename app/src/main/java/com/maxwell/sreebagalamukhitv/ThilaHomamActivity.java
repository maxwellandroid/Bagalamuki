...
public class ThilaHomamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thila_homam);
        ...
        et_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datePickerDialog = new DatePickerDialog(ThilaHomamActivity.this,
        ...
        noOfPersonsPopup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position>0){
                    int amount= Integer.parseInt(noOfPersons.get(position))*1001;
    ...
    public void bookAmavasyaYaagam(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ThilaHomamActivity.this);
    ...
    public void showAlertDialog(String message){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ThilaHomamActivity.this);
