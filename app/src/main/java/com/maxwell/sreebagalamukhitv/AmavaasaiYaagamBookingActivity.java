...
public class AmavaasaiYaagamBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amavaasai_yaagam_booking);
        ...
        et_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datePickerDialog = new DatePickerDialog(AmavaasaiYaagamBookingActivity.this,
  ...
  noOfPersonsPopup.setAdapter(new ArrayAdapter(
    ...
    public void bookAmavasyaYaagam(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AmavaasaiYaagamBookingActivity.this);
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, StringConstants.mainUrl + StringConstants.bookAmavasyaYaagamUrl, new Response.Listener<String>() {
            @Override
    ...
    public void showAlertDialog(String message){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AmavaasaiYaagamBookingActivity.this);
